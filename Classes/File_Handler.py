...
class File_Content_Streamer_Thread(threading.Thread):
    def __init__(self, path, wait_thread=None, is_yield=False, *args, **kwargs):
    ...
    def read_file_continues(self, wait_thread=None, is_yield=False, store_in_buffer=True, is_print=False, sleep_time=1., new_sleep_time=1.):
        time.sleep(1)
